...
title = "Weather Forecast for Australia"
...
def run():
    ...
    st.write("""For several hundreds of years the prediction of the weather has been of large interest for private persons, groups 
            ...
            Today, computers enable weather forecasts to become 
            much more advanced and can reach much further in the future. Traditionally, weather is predicted with physical models, 
